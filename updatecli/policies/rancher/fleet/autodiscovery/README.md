...
```sh
updatecli manifest show --values values.yaml ghcr.io/updatecli/policies/rancher/fleet/autodiscovery:0.6.0
```

```sh
updatecli pipeline diff --values values.yaml ghcr.io/updatecli/policies/rancher/fleet/autodiscovery:0.6.0
```

```sh
updatecli pipeline apply --values values.yaml ghcr.io/updatecli/policies/rancher/fleet/autodiscovery:0.6.0
```
...
updatecli manifest push \
  ...
  --values values.yaml \
  --policy Policy.yaml \
  --tag "$OCI_REGISTRY/rancher/fleet/autodiscovery" \
  .
```
...
```sh
updatecli manifest show "$OCI_REGISTRY/rancher/fleet/autodiscovery:0.6.0"
```
